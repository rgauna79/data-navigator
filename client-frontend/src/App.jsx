...
import { ExcelProvider } from "./context/ExcelContext"; // ✅ Importación necesaria
...
function App() {
  return (
    <BrowserRouter>
      <AuthProvider>
        {/* ✅ ExcelProvider debe envolver a DataProvider porque Data usa a Excel */}
        <ExcelProvider>
          <DataProvider>
            <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
              {/* ✅ Ahora la NavigationBar puede usar useDataContext sin errores */}
              <NavigationBar />
